          ...
          <div class="card-body">
            ...
            <?php }?>
          	...
          	<div class="detail">
	            ...
	            <ul>
	            	<li>Transaction ID: <strong><?=(!empty($transaction)) ? $transaction->transaction_id : ''?></strong></li>
	            	<li>Amount Paid: <strong><?=(!empty($transaction)) ? $transaction->amount : ''?> <?=get_option("currency_code", "")?></strong> </li>
	            </ul>
          	</div>
          </div>
        </div>
